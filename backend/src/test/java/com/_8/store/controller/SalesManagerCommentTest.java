...
class SalesManagerCommentTest {
    ...
    @MockitoBean
    private com._8.store.service.OrderService orderService;

    @MockitoBean
    private com._8.store.service.SalesManagerService salesManagerService;
    ...
    void getPendingComments_returnsEmptyList_whenNoPendingComments() throws Exception {
        ...
        mockMvc.perform(get("/api/sales-manager/comments/pending"))
    ...
    void approveComment_validId_returns200() throws Exception {
        ...
        mockMvc.perform(put("/api/sales-manager/comments/1/approve"))
                .andExpect(status().isOk())
    ...
    void rejectComment_validId_returns200() throws Exception {
        ...
        mockMvc.perform(put("/api/sales-manager/comments/1/reject"))
                .andExpect(status().isOk())
    ...
    void approveComment_invalidId_returns400() throws Exception {
        ...
        mockMvc.perform(put("/api/sales-manager/comments/999/approve"))
    ...
    void rejectComment_invalidId_returns400() throws Exception {
        ...
        mockMvc.perform(put("/api/sales-manager/comments/999/reject"))
                .andExpect(status().is4xxClientError());
    }
}